...
export function showMicrophonePermissionDeniedAlert(canAskAgain: boolean = false) {
  ...
  const message = canAskAgain
    ? 'AgentRejoin needs access to your microphone for voice chat. Please grant permission when prompted.'
    : 'AgentRejoin needs access to your microphone for voice chat. Please enable microphone access in your device settings.';
