...
function makeMetadata(overrides: Partial<Metadata> = {}): Metadata {
    return {
        path: '/Users/test/projects/agentrejoin',
        host: 'test-host',
        homeDir: '/Users/test',
        agentRejoinHomeDir: '/Users/test/.agentrejoin',
        agentRejoinLibDir: '/Users/test/.agentrejoin/lib',
        agentRejoinToolsDir: '/Users/test/.agentrejoin/tools',
        ...overrides,
    };
}
...
describe('getSessionNotificationBody', () => {
    ...
    it('falls back to the last path segment', () => {
        const metadata = makeMetadata({
            path: '/Users/test/projects/agentrejoin-cli',
        });

        expect(getSessionNotificationBody(metadata)).toBe('agentrejoin-cli');
    });
