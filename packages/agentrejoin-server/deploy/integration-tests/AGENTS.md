...
Stress tests that run against a real multi-replica AgentRejoin server on minikube.
...
# Access Redis CLI
kubectl exec -it agentrejoin-redis-0 -- redis-cli

# Access MinIO console
kubectl port-forward svc/agentrejoin-minio 9001:9001
