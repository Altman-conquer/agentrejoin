...
import type { SessionMessageContent } from "agentrejoin-wire";
...
class EventRouter {
    ...
    /**
     * Returns true if the user is demonstrably looking at a AgentRejoin UI client
