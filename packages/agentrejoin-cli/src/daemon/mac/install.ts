/**
 * Installation script for AgentRejoin daemon using macOS LaunchDaemons
 * 
 * NOTE: This installation method is currently NOT USED in favor of auto-starting 
 * the daemon when the user runs the agentrejoin command.
 * 
 ...
 * 2. We assume users will run agentrejoin frequently (every time they open their laptop)
...
const PLIST_LABEL = 'com.agentrejoin-cli.daemon';
...
export async function install(): Promise<void> {
    try {
        ...
        // Get the path to the agentrejoin CLI executable
        ...
        const plistContent = trimIdent(`
            ...
            <dict>
                ...
                <array>
                    ...
                    <string>agentrejoin-daemon</string>
                </array>
                
                <key>EnvironmentVariables</key>
                <dict>
                    <key>AGENTREJOIN_DAEMON_MODE</key>
                    <string>true</string>
                </dict>
                ...
                <string>${os.homedir()}/.agentrejoin/daemon.err</string>
                
                <key>StandardOutPath</key>
                <string>${os.homedir()}/.agentrejoin/daemon.log</string>
        ...
        logger.info('Check logs at ~/.agentrejoin/daemon.log');
