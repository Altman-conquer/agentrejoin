...
describe('pathUtils', () => {
    ...
    describe('resolvePath (existing function)', () => {
        ...
        it('should not resolve sibling directory paths that start with metadata path', () => {
            ...
            expect(resolvePath('/Users/steve/Develop/slopus/agentrejoin-server/sources/types/index.ts', metadata))
                .toBe('/Users/steve/Develop/slopus/agentrejoin-server/sources/types/index.ts');
        });
