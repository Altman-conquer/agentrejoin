...
vi.mock('@/claude/utils/generateHookSettings', () => ({
    generateHookSettingsFile: vi.fn(() => '/tmp/agentrejoin-hook-settings.json'),
...
async function startRemoteRunClaudeHarness(opts: {
    ...
    const sessionClient = {
        sessionId: 'agentrejoin-session-1',
...
describe('runClaude remote JSONL scanner', () => {
    ...
    beforeEach(() => {
        ...
        delete process.env.AGENTREJOIN_RECONNECT_SESSION_ID;
        delete process.env.AGENTREJOIN_RECONNECT_ENCRYPTION_KEY;
        delete process.env.AGENTREJOIN_RECONNECT_ENCRYPTION_VARIANT;
        delete process.env.AGENTREJOIN_RECONNECT_SEQ;
        delete process.env.AGENTREJOIN_RECONNECT_METADATA_VERSION;
        delete process.env.AGENTREJOIN_RECONNECT_AGENT_STATE_VERSION;
        delete process.env.AGENTREJOIN_FORKED_FROM_SESSION_ID;
        delete process.env.AGENTREJOIN_FORKED_FROM_MESSAGE_ID;
        delete process.env.AGENTREJOIN_FORK_CLAUDE_SESSION_ID;
