...
export default function ClaudeOAuth() {
    ...
    return (
        <>
            <OAuthViewUnsupported name="Claude" command="agentrejoin connect claude" />
            {/* <OAuthView
                name="Claude"
                command="agentrejoin connect claude"
...
const OAuthViewUnsupported = React.memo((props: {
    ...
    const command = props.command || `agentrejoin connect ${props.name.toLowerCase()}`;
