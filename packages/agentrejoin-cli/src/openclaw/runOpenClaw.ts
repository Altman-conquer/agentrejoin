 ...
 * The daemon spawns this as: `node dist/index.mjs openclaw --agentrejoin-starting-mode remote --started-by daemon`
 *
 * Connects to an OpenClaw gateway via WebSocket, translates the gateway protocol
 * to AgentRejoin's AgentMessage format, and forwards everything through the session pipeline.
 */
