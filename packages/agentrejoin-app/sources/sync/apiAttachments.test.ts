...
describe('requestAttachmentUpload', () => {
    it('classifies request-upload HTTP failures against the AgentRejoin API host', async () => {
    ...
    it('classifies request-upload network failures against the AgentRejoin API host', async () => {
...
describe('uploadEncryptedBlob', () => {
    ...
    it('classifies PUT blob upload network failures on the AgentRejoin API host without leaking query data', async () => {
        fetchMock.mockRejectedValueOnce(new Error('Failed to fetch'));
