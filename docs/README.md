...
This folder documents how AgentRejoin works internally, with a focus on protocol, backend architecture, deployment, and the CLI tool. Start here.
...
- agentrejoin-wire.md: Shared wire schemas/types package and migration notes.
...
## Conventions
- Paths and field names reflect the current implementation in `packages/agentrejoin-server`.
