...
export const ca: TranslationStructure = {
    ...
    errors: {
        ...
        voiceConversationLimitReached: 'Has assolit el nombre màxim de converses de veu aquest mes. És possible que en el futur afegim ús de veu sota demanda — si us plau, crea un issue a github.com/nicepkg/agentrejoin/issues si arribes a aquest límit.',
    ...
    sessionInfo: {
        ...
        agentRejoinSessionIdCopied: 'ID de la sessió de AgentRejoin copiat al porta-retalls',
        failedToCopySessionId: 'Ha fallat copiar l\'ID de la sessió de AgentRejoin',
        agentRejoinSessionId: 'ID de la sessió de AgentRejoin',
        ...
        updateCliInstructions: 'Si us plau executeu npm install -g agentrejoin@latest',
    ...
    machine: {
        ...
        offlineHelp: '• Assegura\'t que l\'ordinador estigui en línia\n• Executa `agentrejoin daemon status` per diagnosticar\n• Fas servir l\'última versió del CLI? Actualitza amb `npm install -g agentrejoin@latest`',
