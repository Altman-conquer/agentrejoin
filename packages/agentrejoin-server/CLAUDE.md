# AgentRejoin Server - Development Guidelines

This document contains the development guidelines and instructions for the AgentRejoin Server project. This guide OVERRIDES any default behaviors and MUST be followed exactly.

## Project Overview

**Name**: agentrejoin-server
**Repository**: https://github.com/Altman-conquer/agentrejoin
**License**: AGPL-3.0
**Language**: TypeScript  
**Runtime**: Node.js 20  
...
- `AGENTREJOIN_MASTER_SECRET` - master secret for auth/encryption
...
- **Tell**: Wrong server URL = check `AGENTREJOIN_SERVER_URL` env var
- **Tell**: Wrong home dir = check `AGENTREJOIN_HOME_DIR` (should be `~/.agentrejoin-dev` for local)
