...
const files = [
    ...
    'packages/agentrejoin-server/node_modules/pglite-prisma-adapter/dist/index.mjs',
    'packages/agentrejoin-server/node_modules/pglite-prisma-adapter/dist/index.cjs',
];
