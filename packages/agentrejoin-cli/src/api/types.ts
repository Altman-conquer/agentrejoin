import { z } from 'zod'
import type { Update, UpdateMachineBody } from 'agentrejoin-wire';
...
export const MachineMetadataSchema = z.object({
  ...
  homeDir: z.string(),
  agentRejoinHomeDir: z.string(),
  agentRejoinLibDir: z.string(),
...
export type Metadata = {
  ...
  agentRejoinLibDir: string,
  agentRejoinToolsDir: string,
