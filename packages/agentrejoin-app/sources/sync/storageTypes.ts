...
export const MetadataSchema = z.object({
    ...
    codexThreadSyncAvailable: z.boolean().optional(),
    resumeCodexThreadId: z.string().optional(),
    resumeStatus: z.enum(['loading', 'active-writer', 'failed']).optional(),
    tools: z.array(z.string()).optional(),
    slashCommands: z.array(z.string()).optional(),
    mcpServers: z.array(z.object({ name: z.string(), status: z.string() })).optional(),
    skills: z.array(z.string()).optional(),
    homeDir: z.string().optional(), // User's home directory on the machine
    agentRejoinHomeDir: z.string().optional(), // AgentRejoin configuration directory
     ...
     * `parentSessionId` is the AgentRejoin session this one was branched from.
...
export const MachineMetadataSchema = z.object({
    host: z.string(),
    platform: z.string(),
    agentRejoinCliVersion: z.string(),
    agentRejoinHomeDir: z.string(), // Directory for AgentRejoin auth, settings, and logs.
    ...
    shutdownSource: z.enum(['agentrejoin-app', 'agentrejoin-cli', 'os-signal', 'unknown']).optional(),
    ...
    resumeSupport: z.object({
        ...
        requiresAgentRejoinAgentAuth: z.boolean(),
        agentRejoinAgentAuthenticated: z.boolean(),
        detectedAt: z.number(),
    }).optional(),
});
