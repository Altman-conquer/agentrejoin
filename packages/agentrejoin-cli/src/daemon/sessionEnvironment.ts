/**
 * Environment variables that identify one particular AgentRejoin or provider
...
export const SESSION_SCOPED_ENV_KEYS = [
    'AGENTREJOIN_RECONNECT_SESSION_ID',
    'AGENTREJOIN_RECONNECT_ENCRYPTION_KEY',
    'AGENTREJOIN_RECONNECT_ENCRYPTION_VARIANT',
    'AGENTREJOIN_RECONNECT_SEQ',
    'AGENTREJOIN_RECONNECT_METADATA_VERSION',
    'AGENTREJOIN_RECONNECT_AGENT_STATE_VERSION',
    'AGENTREJOIN_FORKED_FROM_SESSION_ID',
    'AGENTREJOIN_FORKED_FROM_MESSAGE_ID',
    'AGENTREJOIN_FORK_CLAUDE_SESSION_ID',
    'AGENTREJOIN_FORK_CODEX_THREAD_ID',
    'AGENTREJOIN_SIDE_CHAT',
    'CODEX_THREAD_ID',
] as const;
