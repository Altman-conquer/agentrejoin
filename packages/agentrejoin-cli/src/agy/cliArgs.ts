...
/**
 * AgentRejoin permission modes that map to agy's `--dangerously-skip-permissions`
 ...
 * agy's policy rather than gating per-tool in AgentRejoin.
 */
...
export interface BuildAgyArgsOptions {
  ...
  /** AgentRejoin permission mode for this turn. */
