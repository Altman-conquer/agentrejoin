...
// which resolves the module from a real path on disk. agentrejoin-server ships as a
// single-file `bun build --compile` binary (see agentrejoin-cli `agentrejoin server`); inside
