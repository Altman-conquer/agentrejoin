# AgentRejoin Content Creator Brief

## Key Features

AgentRejoin is an open-source mobile app that lets developers control AI coding agents (Claude Code, Codex, Gemini-CLI) from their phone.
...
- On AgentRejoin, I can manage Claude Code from my phone without paying $600/year
- On AgentRejoin, I never miss when Claude gets stuck on a permission prompt
- AgentRejoin runs on my own computer, not expensive cloud servers
- On AgentRejoin, I can check on long-running tasks without returning to my desk
- AgentRejoin is open source - I can audit, modify, or self-host everything
- On AgentRejoin, I can run multiple agents in parallel and switch between them instantly
- AgentRejoin keeps my code on my machines with end-to-end encryption
- On AgentRejoin, I can keep coding while commuting, eating, or away from my desk

## Example Hooks

- "I saved $600/year by switching from [competitor] to the open-source AgentRejoin"
...
- Clearly say "AgentRejoin" in the video or caption
- Mention it's free and open source
- Include link to github.com/Altman-conquer/agentrejoin
...
- GitHub: https://github.com/Altman-conquer/agentrejoin
- Website: https://agentrejoin.zhandj.com
- Mobile builds: https://github.com/Altman-conquer/agentrejoin/releases
- Web App: https://agentrejoin.zhandj.com/app
