...
import { VoiceConversationResponseSchema, VoiceUsageResponseSchema } from "agentrejoin-wire";
...
function deriveElevenUserId(happyUserId: string): string {
    const hmac = crypto.createHmac("sha256", process.env.AGENTREJOIN_MASTER_SECRET!);
