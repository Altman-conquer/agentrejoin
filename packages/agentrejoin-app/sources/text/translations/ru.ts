...
export const ru: TranslationStructure = {
    ...
    errors: {
        ...
        voiceConversationLimitReached: 'Вы достигли максимального количества голосовых разговоров в этом месяце. Возможно, в будущем мы добавим голосовое использование по запросу — пожалуйста, создайте заявку на github.com/nicepkg/agentrejoin/issues, если вы столкнулись с этим ограничением.',
    ...
    sessionInfo: {
        ...
        agentRejoinSessionIdCopied: 'ID сессии AgentRejoin скопирован в буфер обмена',
        failedToCopySessionId: 'Не удалось скопировать ID сессии AgentRejoin',
        agentRejoinSessionId: 'ID сессии AgentRejoin',
        ...
        updateCliInstructions: 'Пожалуйста, выполните npm install -g agentrejoin@latest',
    ...
    machine: {
        ...
        offlineHelp: '• Убедитесь, что компьютер online\n• Выполните `agentrejoin daemon status` для диагностики\n• Используете последнюю версию CLI? Обновите командой `npm install -g agentrejoin@latest`',
