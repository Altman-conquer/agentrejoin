...
export const pt: TranslationStructure = {
    ...
    errors: {
        ...
        voiceConversationLimitReached: 'Você atingiu o número máximo de conversas de voz este mês. Podemos adicionar uso de voz sob demanda no futuro — por favor, abra um issue em github.com/nicepkg/agentrejoin/issues se você atingir este limite.',
    ...
    sessionInfo: {
        ...
        agentRejoinSessionIdCopied: 'ID da sessão AgentRejoin copiado para a área de transferência',
        failedToCopySessionId: 'Falha ao copiar ID da sessão AgentRejoin',
        agentRejoinSessionId: 'ID da sessão AgentRejoin',
        ...
        updateCliInstructions: 'Por favor execute npm install -g agentrejoin@latest',
    ...
    agentInput: {
        stop: 'Parar',
        queuedFollowUp: 'Na fila para o próximo turno',
        permissionMode: {
    ...
    machine: {
        ...
        offlineHelp: '• Verifique se seu computador está online\n• Execute `agentrejoin daemon status` para diagnosticar\n• Você está usando a versão mais recente do CLI? Atualize com `npm install -g agentrejoin@latest`',
