 ...
 * the AgentRejoin CLI and mobile app.
 * 
 ...
 * These messages are forwarded to the AgentRejoin server and mobile app.
 */
 ...
 * this interface to be usable through the AgentRejoin CLI and mobile app.
 */
