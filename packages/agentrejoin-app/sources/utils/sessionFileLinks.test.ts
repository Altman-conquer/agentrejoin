...
describe('sessionFileLinks', () => {
    ...
    it('parses absolute file refs with line numbers', () => {
        const result = parseSessionFileLink('/Users/kirilldubovitskiy/projects/happy/packages/agentrejoin-cli/src/codex/runCodex.ts:594', {
            sessionRoot,
        });

        expect(result).toEqual({
            path: '/Users/kirilldubovitskiy/projects/happy/packages/agentrejoin-cli/src/codex/runCodex.ts',
            absolutePath: '/Users/kirilldubovitskiy/projects/happy/packages/agentrejoin-cli/src/codex/runCodex.ts',
            relativePath: 'packages/agentrejoin-cli/src/codex/runCodex.ts',
    ...
    it('parses relative file refs with line and column numbers', () => {
        const result = parseSessionFileLink('packages/agentrejoin-cli/src/codex/runCodex.ts:594:2', {
            sessionRoot,
        });

        expect(result).toEqual({
            path: 'packages/agentrejoin-cli/src/codex/runCodex.ts',
            absolutePath: '/Users/kirilldubovitskiy/projects/happy/packages/agentrejoin-cli/src/codex/runCodex.ts',
            relativePath: 'packages/agentrejoin-cli/src/codex/runCodex.ts',
            withinSessionRoot: true,
            line: 594,
    ...
    it('splits bare text into plain and linked segments', () => {
        const result = splitSessionFileText('Open packages/agentrejoin-cli/src/codex/runCodex.ts:594 please.', sessionRoot);

        expect(result).toEqual([
            { text: 'Open ', link: null },
            {
                text: 'packages/agentrejoin-cli/src/codex/runCodex.ts:594',
                link: {
                    path: 'packages/agentrejoin-cli/src/codex/runCodex.ts',
                    absolutePath: '/Users/kirilldubovitskiy/projects/happy/packages/agentrejoin-cli/src/codex/runCodex.ts',
                    relativePath: 'packages/agentrejoin-cli/src/codex/runCodex.ts',
    ...
    it('resolves viewer input to an absolute path', () => {
        expect(resolveSessionFilePath('packages/agentrejoin-app/README.md', sessionRoot)).toEqual({
            path: 'packages/agentrejoin-app/README.md',
            absolutePath: '/Users/kirilldubovitskiy/projects/happy/packages/agentrejoin-app/README.md',
            relativePath: 'packages/agentrejoin-app/README.md',
            withinSessionRoot: true,
            line: null,
            column: null,
        });
