...
export function startSocket(app: Fastify) {
    ...
    io.use(async (socket, next) => {
        ...
        socket.data.agentRejoinClient = socket.handshake.auth.agentRejoinClient as string
            || socket.handshake.headers['x-agentrejoin-client'] as string
            || undefined;
        next();
    });
    ...
    io.on("connection", (socket) => {
        ...
        const agentRejoinClient = socket.data.agentRejoinClient as string | undefined;
