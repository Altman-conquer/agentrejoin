...
function showConnectHelp(): void {
    console.log(`
${chalk.bold('happy connect')} - Connect AI vendor API keys to AgentRejoin

${chalk.bold('Usage:')}
  happy connect codex        Store your Codex API key in AgentRejoin
  happy connect claude       Store your Anthropic API key in AgentRejoin
  happy connect gemini       Store your Gemini API key in AgentRejoin
...
${chalk.bold('Notes:')} 
  • You must be authenticated with AgentRejoin first (run 'happy auth login')
